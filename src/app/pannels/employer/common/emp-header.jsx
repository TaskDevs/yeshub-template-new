              ...
              <ul className="header-widget-wrap">
                ...
                <li className="header-widget dashboard-message-dropdown">
                  <div className="dropdown">
                    <a
                      href="#"
                      className="dropdown-toggle YesHub-admin-messange"
                      id="ID-MSG_dropdown"
                      ...
                      <div className="message-list dashboard-widget-scroll">
                        <ul>
                          ...
                          <li className="clearfix">
                            <span className="msg-avtar">
                              <JobZImage
                                src="images/user-avtar/pic2.jpg"
                                alt=""
                              />
                            </span>
                            <div className="msg-texting">
                          ...
                          <li className="clearfix">
                            <span className="msg-avtar">
                              <JobZImage
                                src="images/user-avtar/pic3.jpg"
                                alt=""
                              />
                            </span>
                            <div className="msg-texting">
                ...
                <li className="header-widget dashboard-noti-dropdown">
                  <div className="dropdown">
                    <a
                      href="#"
                      className="dropdown-toggle YesHub-admin-notification"
                      id="ID-NOTI_dropdown"
                      data-bs-toggle="dropdown"
                    >
