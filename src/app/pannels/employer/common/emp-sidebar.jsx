				...
				>
					...
					<div className="admin-nav scrollbar-macosx">
						<ul>
							...
							>
								<NavLink to={empRoute(employer.ADD_CATEGORY)}>
									<i className="fa fa-user-tie" />
							...
							>
								<NavLink to={empRoute(employer.ADD_SKILL)}>
									<i className="fa fa-user-tie" />
							...
							>
								...
								<ul className="sub-menu">
									<li>
										{" "}
										<NavLink to={empRoute(employer.POST_A_JOB)} id="jobMenuId1">
									...
									<li>
										{" "}
										<NavLink
											to={empRoute(employer.MANAGE_JOBS)}
											id="jobMenuId2"
										>
							...
							>
								...
								<ul className="sub-menu">
									<li>
										{" "}
										<NavLink to={empRoute(employer.MESSAGES1)} id="msgMenuId1">
							...
							<li
								className={setMenuActive(
									currentpath,
									empRoute(employer.REVIEWS)
								)}
							>
								<NavLink to={empRoute(employer.REVIEWS)}>
									<i className="fa fa-comments" />
									<span className="admin-nav-text">Reviews</span>
								</NavLink>
							</li>
