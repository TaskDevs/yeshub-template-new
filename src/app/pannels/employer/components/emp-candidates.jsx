...
function EmpCandidatesPage() {
    ...
    const { processGetAllApplication } = useContext(ApplicationApiData)
    useState(()=> {
									...
									>
										...
										<tbody>
											...
											<tr>
												...
												<td>
													<div className="twm-jobs-category">
														<span className="twm-bg-green">Approved</span>
													</div>
												</td>
												<td>
											...
											<tr>
												...
												<td>
													<div className="twm-jobs-category">
														<span className="twm-bg-golden">Pending</span>
													</div>
												</td>
												<td>
													<div className="twm-table-controls">
											...
											<tr>
												...
												<td>
													<div className="twm-jobs-category">
														<span className="twm-bg-red">Rejects</span>
													</div>
												</td>
												<td>
													<div className="twm-table-controls">
