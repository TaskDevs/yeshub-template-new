                ...
                <div className="row">
                    ...
                    <div className="col-xl-6 col-lg-6 col-md-12">
                        <div className="twm-bnr-left-section">
                            <div className="twm-bnr-title-small">An Initiative By <span className="site-text-secondry">H.E.</span> President John Dramani Mahama</div>
                            <div className="twm-bnr-title-large">YES Hub <span className="site-text-primary">Transforming Dreams </span> Into Careers</div>
                            <div className="twm-bnr-discription">More than a job portal, this comprehensive tool for youth empowerment offers Ghana’s youth access to jobs, skill enhancement, and career-building resources through tailored training and opportunities.</div>
                                    ...
                                    <div className="col-xl-6 col-lg-6 col-md-6">
                                        <div className="twm-w-process-steps-2">
                                            <div className="twm-w-pro-top bg-clr-sky-light bg-sky-light-shadow">
                                                ...
                                                <h4 className="twm-title">Simplified <br />SignUp</h4>
                                                <p>Register with LinkedIn or Google in one click. No hassle, just instant access to opportunities designed for you.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-xl-6 col-lg-6 col-md-6">
                                        <div className="twm-w-process-steps-2">
                                            <div className="twm-w-pro-top bg-clr-yellow-light bg-yellow-light-shadow">
                                                ...
                                                <h4 className="twm-title">Smart <br />
                                                Profile Builder</h4>
                                                <p>Build a unique AI powered profile based on your data, linking your skills to relevant assessments and showcasing your potential.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-xl-6 col-lg-6 col-md-6">
                                        <div className="twm-w-process-steps-2">
                                            <div className="twm-w-pro-top bg-clr-pink-light bg-pink-light-shadow">
                                                ...
                                                <h4 className="twm-title">Be <br />Seen By The Best</h4>
                                                <p>Your profile is positioned to attract top employers and opportunities, ensuring you’re always a step closer to your dream job.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-xl-6 col-lg-6 col-md-6">
                                        <div className="twm-w-process-steps-2">
                                            <div className="twm-w-pro-top bg-clr-green-light bg-clr-light-shadow">
                                                ...
                                                <h4 className="twm-title">Tailored <br />Matches</h4>
                                                <p>We connect you to jobs and skills assessments that perfectly align with your expertise and ambitions, saving you time and effort.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="col-lg-8 col-md-12">
                                    <div className="twm-explore-content-outer2">
                                        <div className="twm-explore-top-section">
                                            <div className="twm-title-small">Opportunities For All</div>
                                            <div className="twm-title-large">
                                                <h2>One Platform For All Job Placements</h2>
                                                <p>Designed to create a fair and vibrant job economy, this platform connects the youth with opportunities across government and private sectors. By prioritizing equal access and merit, it fosters meaningful careers and drives sustainable development.</p>
                                            </div>
                            ...
                            <div className="col-lg-7 col-md-12">
                                <div className="twm-explore-content-outer-3">
                                    <div className="twm-explore-content-3">
                                        <div className="twm-title-small">Validate, Learn, and Succeed</div>
                                        <div className="twm-title-large">
                                            <h2>Skills That Speak for You</h2>
                                            <p>With a focus on skills validation and personalized assessments, we help you highlight your strengths and identify areas for growth. Our training programs empower you to bridge gaps, improve your capabilities, and secure the job you’ve always wanted.</p>
                                        </div>
                                        <div className="twm-upload-file">
                                            <button type="button" className="site-button">Validate Your Skills <i className="feather-upload" /></button>
                                        </div>
                                    </div>
