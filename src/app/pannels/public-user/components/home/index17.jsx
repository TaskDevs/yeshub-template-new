							...
							<div className="col-xl-6 col-lg-6 col-md-12">
								<div className="twm-bnr-right-section">
									...
									<div className="twm-bnr-title-large">
										Find Your Perfect{" "}
										<span className="site-text-white">Job</span> Platform
									</div>
									<div className="twm-bnr-discription">
										Explore all the most exciting job roles based on your
										interest and study major. your dream job is waiting for you.
									</div>
								...
								<div className="col-xl-5 col-lg-5 col-md-12 wt-separator-two-part-left">
									...
									<div className="section-head left wt-small-separator-outer">
										...
										<h2 className="wt-title">
											Find your favourite jobs and get.
										</h2>
									</div>
									{/* title="" END*/}
								</div>
									...
									<div
										...
										style={{
											backgroundImage: `url(${publicUrlFor(
												"images/home-5/featured-cities/city1.jpg"
											)})`,
										}}
									></div>
							...
							<div className="item">
								...
								<div className="twm-featured-city2">
									<div
										...
										style={{
											backgroundImage: `url(${publicUrlFor(
												"images/home-5/featured-cities/city2.jpg"
											)})`,
										}}
									></div>
									<div className="twm-city-info">
										<h4 className="twm-title">
											<NavLink to={publicUser.jobs.LIST}>Paris, France</NavLink>
										</h4>
							...
							<div className="item">
								...
								<div className="twm-featured-city2">
									<div
										...
										style={{
											backgroundImage: `url(${publicUrlFor(
												"images/home-5/featured-cities/city3.jpg"
											)})`,
										}}
									></div>
									<div className="twm-city-info">
										<h4 className="twm-title">
											<NavLink to={publicUser.jobs.LIST}>New York, USA</NavLink>
										</h4>
							...
							<div className="item">
								...
								<div className="twm-featured-city2">
									<div
										...
										style={{
											backgroundImage: `url(${publicUrlFor(
												"images/home-5/featured-cities/city4.jpg"
											)})`,
										}}
									></div>
									<div className="twm-city-info">
							...
							<div className="item">
								...
								<div className="twm-featured-city2">
									<div
										...
										style={{
											backgroundImage: `url(${publicUrlFor(
												"images/home-5/featured-cities/city5.jpg"
											)})`,
										}}
									></div>
									<div className="twm-city-info">
							...
							<div className="item">
								...
								<div className="twm-featured-city2">
									<div
										...
										style={{
											backgroundImage: `url(${publicUrlFor(
												"images/home-5/featured-cities/city6.jpg"
											)})`,
										}}
									></div>
									<div className="twm-city-info">
								...
								<div className="col-lg-5 col-md-12">
									<div className="h-page-6-getjobs-right">
										...
										<div className="section-head left wt-small-separator-outer">
											...
											<h2 className="wt-title">
												Get World{" "}
												<span className="site-text-primary">1500+</span>
											...
											<p>
												Find the best and preferred job. lorem Ipsum is simply
												dummy text of the printing and typesetting industry the
				...
				<div className="section-full p-t120 p-b90 site-bg-white twm-hpage-6-featured-outer">
					...
					<div className="twm-hpage-6-featured-area">
						<div className="twm-hpage-6-featured-bg-warp">
							<div className="twm-media">
								<JobZImage
									src="images/home-6/featured-jobs/large-pic-1.png"
									alt="#"
								/>
							</div>
						</div>
												...
												<div className="hpage-6-featured-block">
													<div className="inner-content">
														...
														<div className="mid-content">
															<div className="company-logo">
																<JobZImage
																	src="images/home-6/featured-jobs/behance.png"
																	alt="#"
																/>
															</div>
															<div className="company-info">
										...
										<div className="hpage-6-featured-block">
											<div className="inner-content">
												...
												<div className="mid-content">
													<div className="company-logo">
														<JobZImage
															src="images/home-6/featured-jobs/yahoo.png"
															alt="#"
														/>
													</div>
													<div className="company-info">
										...
										<div className="hpage-6-featured-block">
											<div className="inner-content">
												...
												<div className="mid-content">
													<div className="company-logo">
														<JobZImage
															src="images/home-6/featured-jobs/google.png"
															alt="#"
														/>
													</div>
													<div className="company-info">
											...
											<div className="twm-explore-content-3">
												...
												<div className="twm-title-large">
													...
													<p>
														...
														since the when an printer took. lorem Ipsum is
														simply dummy text.
													</p>
												</div>
													...
													<div className="swiper-slide">
														<div className="twm-testi-content">
															...
															<div className="t-discription">
																I just got a job that I applied for via
																careerfy! I used the site all the time during my
																job hunt.get notification everyday and you can
																easily apply directly to the company you want
																create and account now for free.
															</div>
														...
														<div className="p-table-inner">
															...
															<div className="p-table-list">
																<ul>
																	...
																	<li>
																		<i className="feather-check" />0 featured
																		job
																	</li>
																	<li>
