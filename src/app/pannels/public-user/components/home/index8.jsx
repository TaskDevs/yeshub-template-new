...
function Home8Page() {
    ...
    return (
			<>
				{/*Banner Start*/}
				<div
					className="twm-home8-banner-section site-bg-white bg-cover"
					style={{
						backgroundImage: `url(${publicUrlFor(
							"images/home-8/h8-banner.jpg"
						)})`,
					}}
				>
								...
								<div className="col-lg-7 col-md-12">
									<div className="twm-bnr-left-section">
										...
										<div className="twm-bnr-discription">
											Over <span className="text-clr-pink">1800+ </span> jobs
											are waiting for you
										</div>
										...
										<div className="twm-jobs-st5  m-b30">
											...
											<div className="twm-job-st5-top">
												<div className="twm-media">
													<JobZImage
														src="images/home-5/jobs-company/pic1.jpg"
														alt="#"
													/>
												</div>
												<div className="twm-com-info">
													...
													<a
														...
														className="twm-job-com-name site-text-primary"
													>
														Crystel Inc Pvt. Ltd.
													</a>
												</div>
											...
											<div className="twm-mid-content">
												...
												<div className="twm-job-duration">
													<ul>
														...
														<li>
															<span className="twm-job-post-duration">
																<i className="far fa-clock" />4 Minutes ago
															</span>
														</li>
													</ul>
												</div>
									...
									<div className="col-lg-6 col-md-6">
										<div className="twm-jobs-st5  m-b30">
											...
											<div className="twm-job-st5-top">
												<div className="twm-media">
													<JobZImage
														src="images/home-5/jobs-company/pic2.jpg"
														alt="#"
													/>
												</div>
												<div className="twm-com-info">
									...
									<div className="col-lg-6 col-md-6">
										<div className="twm-jobs-st5  m-b30">
											...
											<div className="twm-job-st5-top">
												<div className="twm-media">
													<JobZImage
														src="images/home-5/jobs-company/pic3.jpg"
														alt="#"
													/>
												</div>
												<div className="twm-com-info">
									...
									<div className="col-lg-6 col-md-6">
										<div className="twm-jobs-st5  m-b30">
											...
											<div className="twm-job-st5-top">
												<div className="twm-media">
													<JobZImage
														src="images/home-5/jobs-company/pic4.jpg"
														alt="#"
													/>
												</div>
												<div className="twm-com-info">
									...
									<div className="twm-how-t-get-section-left">
										<div className="section-head left wt-small-separator-outer">
											...
											<p>
												...
												get notification everyday and you can easily apply
												directly to the company you want create and account now
												for free.
											</p>
										</div>
									...
									<div className="twm-how-t-get-section-right">
										...
										<div className="twm-left-img-bx bounce">
											<div className="twm-left-img-media">
												<JobZImage
													src="images/home-7/img-bx/pic1.jpg"
													alt="#"
												/>
											</div>
										...
										<div className="twm-profile-card bounce2">
											<div className="twm-profile-pic">
												<JobZImage
													src="images/home-7/img-bx/pic3.jpg"
													alt="#"
												/>
											</div>
								...
								<div className="col-lg-5 col-md-12">
									<div className="twm-testimonial-page8-left">
										<div className="twm-media bounce2">
											<JobZImage
												src="images/home-8/testimonial-3d-pic.png"
												alt="#"
											/>
										</div>
								...
								<div className="row">
										...
										<div className="blog-post twm-blog-post-h5-outer">
											<div className="wt-post-media">
												<NavLink to={publicUser.blog.DETAIL}>
													<JobZImage src="images/home-5/blog/pic1.jpg" alt="" />
												</NavLink>
											</div>
											<div className="wt-post-info">
												<div className="post-author">
													<div className="post-author-pic">
														<div className="p-a-pic">
															<JobZImage
																src="images/home-5/blog-avtar/pic1.jpg"
																alt=""
															/>
														</div>
									...
									<div className="col-lg-4 col-md-6">
										...
										<div className="blog-post twm-blog-post-h5-outer">
											<div className="wt-post-media">
												<NavLink to={publicUser.blog.DETAIL}>
													<JobZImage src="images/home-5/blog/pic2.jpg" alt="" />
												</NavLink>
											</div>
											<div className="wt-post-info">
												<div className="post-author">
													<div className="post-author-pic">
														<div className="p-a-pic">
															<JobZImage
																src="images/home-5/blog-avtar/pic2.jpg"
																alt=""
															/>
														</div>
														<div className="p-a-info">
									...
									<div className="col-lg-4 col-md-6">
										...
										<div className="blog-post twm-blog-post-h5-outer">
											<div className="wt-post-media">
												<NavLink to={publicUser.blog.DETAIL}>
													<JobZImage src="images/home-5/blog/pic3.jpg" alt="" />
												</NavLink>
											</div>
											<div className="wt-post-info">
												<div className="post-author">
													<div className="post-author-pic">
														<div className="p-a-pic">
															<JobZImage
																src="images/home-5/blog-avtar/pic3.jpg"
																alt=""
															/>
														</div>
														<div className="p-a-info">
