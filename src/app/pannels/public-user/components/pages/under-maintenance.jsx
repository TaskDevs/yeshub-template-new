								...
								<div className="twm-u-maintenance-content">
									<div className="media">
										<NavLink to={publicUser.HOME1}>
											<JobzImage
												id="skin_maintain_logo"
												src="images/logo-light-2.png"
												alt=""
											/>
										</NavLink>
									</div>
									<h2 className="twm-u-maintenance-title">
										Website is under{" "}
										<span className="site-text-primary">Maintenance</span>
									</h2>
									<p className="twm-u-maintenance-title2">
										We apologize for any Inconvenience caused. We&apos;ve almost
										done.
									</p>
