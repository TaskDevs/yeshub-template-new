      ...
      <div className="row">
        ...
        <div className="col-sm-12 col-md-6 px-2">
          <div className="d-flex flex-sm-col flex-md-row justify-content-center gap-4">
            {/* Hourly Option */}
            <div
              className={`option-card ${selectedOption === "hourly" ? "selected" : ""}`}
            ...
            {/* Fixed Option */}
            <div
              className={`option-card ${selectedOption === "fixed" ? "selected" : ""}`}
            ...
            <>
              <div className="flex gap-4 p-3 mt-4">
                <InputField
                  ...
                  label={START_CLIENT_PROFILE_FIELD.fieldDetailFour[0].label}
                  value={forms[0]}
                  change={(data, field) => handleInputChange(field, data)}
                />
                <InputField
                  field={START_CLIENT_PROFILE_FIELD.fieldDetailFour[1]}
                  label={START_CLIENT_PROFILE_FIELD.fieldDetailFour[1].label}
                  value={forms[0]}
                  change={(data, field) => handleInputChange(field, data)}
                />
              </div>
              ...
              <p className="text-muted mt-2 mx-4">
                Professionals tend to charge GH10 - GH25 /hour for graphic design projects. Experts may charge higher
              </p>
            </>
          ) : (
            <>
              <div className="mt-4 mx-4">
                <p className="text-muted mt-2">
                  ...
                  divide the project into milestones and pay as each milestone is completed.
                </p>
                <div className="mt-4">
              ...
              <div className="input-container mt-4 px-4">
                <InputField
