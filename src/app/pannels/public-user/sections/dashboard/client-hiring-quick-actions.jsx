...
export const ClientQuickActions = ({ styles }) => {
  return (
    <div className={`bg-white flex items-start flex-col h-full p-4 rounded-lg shadow-sm ${styles}`}>
      ...
      <div className="flex flex-col items-start w-full">
        <div className="flex flex-row gap-3 w-full -mt-5">
          <QuickActionItem icon={FaClock} label="Post a Job" />
          <QuickActionItem icon={IoDocumentText} label="Review Proposals" />
        </div>
        <div className="flex flex-row gap-3 w-full pb-14">
          <QuickActionItem icon={IoIosSearch} label="Find Talent" />
