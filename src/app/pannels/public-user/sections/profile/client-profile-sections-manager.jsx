...
export const ClientProfileSectionsManager = ({
  sectionKeyMap,
  clientData,
  profileSections,
}) => {
  return (
    <div className="space-y-5 mt-24 w-full">
      ...
      <div className="flex flex-row w-full items-start space-x-3">
        ...
        <div
          className={`flex flex-col items-start justify-start ${styles.clientLeftColumn}`}
        >
          <ProfileSection
        ...
        <div
          className={`flex flex-col items-start justify-start ${styles.clientRightColumn}`}
        >
          <ProfileSection
